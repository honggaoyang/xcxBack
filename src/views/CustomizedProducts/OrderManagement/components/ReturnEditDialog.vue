<template>
  <el-dialog title="退回订单修改" :visible.sync="isShowDialog" width="600px" @closed="onClosedDialog">
    <el-form ref="formRef" :model="form" :inline="false" :rules="formRules" label-width="80px" style="margin-top:20px">
      <el-form-item label="退回原因" prop="reason">
        <el-input maxlength="500" type="textarea" :autosize="{ minRows: 2, maxRows: 5}" v-model="form.reason" placeholder="输入退回原因"></el-input>
      </el-form-item>
    </el-form>
    <span slot="footer">
    ...
    return {
      ...
      formRules: {
        reason: [
          ...
          { pattern: /\S+/, message: '请输入退回原因', trigger: 'blur' }
        ],
      }
